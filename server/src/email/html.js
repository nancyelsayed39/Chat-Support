...
<p>Before we get started, we'll need to verify your email.</p>
          ...
          </div></td></tr><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;" align="center" border="0"><tbody><tr><td style="border:none;border-radius:3px;color:white;cursor:auto;padding:20px 40px;font-size:24px;font-weight:bold;letter-spacing:5px;" align="center" valign="middle" bgcolor="#2563EB">
            ${code}
